...
- **`/play/spike`** — browser **WASM PS1** spike (vendored WASMpsx, MIT); file picker for local disc images; **not** wired to `psx-runtime` yet. See [`docs/playable-emulator-spike.md`](../../docs/playable-emulator-spike.md).
