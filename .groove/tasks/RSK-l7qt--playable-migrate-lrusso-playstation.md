...
**Id:** **`RSK-l7qt`** — swap to lrusso/PlayStation. **`RSK-l7qs`** is **Playable 03** (`IRuntime` / emulator adapter), not this task.

**RSK-l7qp** originally used **js-emulators/wasmpsx**. **RSK-l7qt** migrated **`/play/spike`** to **[lrusso/PlayStation](https://github.com/lrusso/PlayStation)** (sound, UI), vendored under `apps/web/public/playstation/`.
