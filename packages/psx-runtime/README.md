...
**Browser emulator spike:** a separate **WASM PS1** experiment (`/play/spike` in `apps/web`, WASMpsx) is **not** integrated with `IRuntime` yet — see [`docs/playable-emulator-spike.md`](../../docs/playable-emulator-spike.md).
